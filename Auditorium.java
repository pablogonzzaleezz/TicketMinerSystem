 ...
 *
 * Represents an Auditorium venue in the TicketMiner system.
 */
public class Auditorium extends Venue {

    /**
     * Creates a new Auditorium venue.
     *
     * @param id venue ID
     ...
     */
    public Auditorium(int id, String name, int capacity, int concertCapacity, double cost, double vipPercent){
